...
PCA is is first foray into exploring latent variables. 
Idea is to measure a lot of variables, from a few to a shitton. 
...
We run FA, throw everything into SPPS (R) and see if we get any really big factors. 
...
These two are not the same thing! REFERENCE!
With **CFA** you are testing a theory.
This cannot be done in SPSS, but we can do it in R.
