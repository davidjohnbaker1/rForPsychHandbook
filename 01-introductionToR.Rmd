...
9. There are a lot of ways that R intergrates into other software. This book is written in [bookdown](https://bookdown.org/home/), [my website](http://davidjohnbaker.rbind.io/) is written in [blogdown](https://github.com/rstudio/blogdown), you can also make [interactive data applications](https://shiny.rstudio.com/).
...
If you are programming you need to do this entire act of picking whre you are working right away by saving your script (the what) and setting your working directory (the where).
This is the most tedious part of starting to learn R, but once you are over this hump, the others will not feel as bad. 
...
[WORKING DIRECTORY SET UP GUIDE]
